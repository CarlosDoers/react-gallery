...
import "./InteractiveNebulaShader.css";
...
export default function InteractiveNebulaShader({
  ...
  return (
    <div
      ref={containerRef}
      className={`interactive-nebula-container ${className}`}
      aria-label="Interactive nebula background"
    />
  );
}

InteractiveNebulaShader.propTypes = {
  hasActiveReminders: PropTypes.bool,
  hasUpcomingReminders: PropTypes.bool,
  disableCenterDimming: PropTypes.bool,
